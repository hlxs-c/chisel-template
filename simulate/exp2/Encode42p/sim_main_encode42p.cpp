...
void sim_init() {
	...
	top = new VEncode42p{contextp};
	contextp->traceEverOn(true);
	top->trace(tfp, 0);
	tfp->open("Encode42p.vcd");
}
...
int main() {
    ...
    top->io_x =0b1001; step_and_dump_wave();
    top->io_x =0b0101; step_and_dump_wave();
    top->io_x =0b0011; step_and_dump_wave();
    top->io_x =0b0001; step_and_dump_wave();
